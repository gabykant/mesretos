        ...
        <div class="container">
            ...
            <!-- Links -->
                <ul class="nav navbar-nav navbar-right">
                    <li><a href="<?php echo base_url() ?>welcome/register"><i class="glyphicon glyphicon-user"></i> Ouvrir un compte</a></li>
                    <li><a href="<?php echo base_url() ?>welcome/login"><i class="glyphicon glyphicon-log-in"></i> Se connecter <span class="caret"></span></a></li>
